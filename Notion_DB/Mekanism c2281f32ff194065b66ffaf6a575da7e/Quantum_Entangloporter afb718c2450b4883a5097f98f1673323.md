...
The **Quantum Entangloporter** from Mekanism is a machine that allows liquids/items/energy/gas to be sent from one **Quantum Entangloporter** to another through a channel. The **Quantum Entangloporter** is similar to the Tesseract from Thermal Expansion, but the **Quantum Entangloporter** can send and receive gasses while the Tesseract cannot.
...
Refined Obsidian Ingot + Atomic Alloy + Teleportation Core |
