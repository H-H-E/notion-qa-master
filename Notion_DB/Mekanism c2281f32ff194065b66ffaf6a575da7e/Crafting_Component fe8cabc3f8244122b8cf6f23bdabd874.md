...
**Crafting Component**s are items which only serve the purpose of being used to craft items.

## List

Item | Recipes used in |
— | — |
 Infused Alloy | 38 |
 Reinforced Alloy | 13 |
 Atomic Alloy | 10 |
 Electrolytic Core | 2 |
 Teleportation Core | 3 |
 Basic Control Circuit | 41 |
 Advanced Control Circuit | 10 |
 Elite Control Circuit | 10 |
 Ultimate Control Circuit | 0 |
