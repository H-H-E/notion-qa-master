...
The High-density polyethylene (HDPE) pellet is an ingredient used to create HDPE Sheets and HDPE Rods.

File:ImageHDPEpelletCraft CraftImage by DJGauth texte descriptif Schema by DJGauth ## Crafting recipe

Created in a Pressurized Reaction Chamber (PRC) from Substrate, Liquid Ethylene (Ethylene condensed in Rotary Condensentrator) and Oxygen.
