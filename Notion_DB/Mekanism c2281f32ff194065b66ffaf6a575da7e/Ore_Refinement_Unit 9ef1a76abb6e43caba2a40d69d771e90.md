...
The Ore Refinement Unit is a Module in Mekanism that is installed onto the Meka-Tool, which gives the tool the property of the Fortune Enchantment.
...
Reinforced Alloy + Refined Glowstone + Module Base + Polonium Pellet |
