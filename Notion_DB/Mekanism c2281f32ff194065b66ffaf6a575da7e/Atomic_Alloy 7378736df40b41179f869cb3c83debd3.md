...
**Alloys** are key components in crafting Mekanism machines/tools. They are present in many recipes, and different recipes may require different tiers of Alloys. For example, an Energy Tablet would require Infused Alloys, but a Robit would require Atomic Alloys.
...
Redstone or Block of Redstone or Enriched Redstone |
...
Diamond Dust or Enriched Diamond |
...
Refined Obsidian Dust or Enriched Obsidian |
...
— | — | — |
Dosimeter Unit | HDPE Sheet +

Dosimeter + Module Base + Infused Alloy |
...
| | Electrolytic Breathing Unit | HDPE Sheet + Electrolytic Core + Module Base + Infused Alloy |
...
| | Energy Unit | HDPE Sheet + Basic Induction Cell + Module Base + Infused Alloy |
...
| | Radiation Shielding Unit | HDPE Sheet + Lead Block + Module Base + Infused Alloy |
...
| | Advanced Bin | Cobblestone + Advanced Control Circuit + Basic Bin + Infused Alloy |
...
| | Advanced Fluid Tank | Infused Alloy + Iron Ingot + Basic Fluid Tank |
...
| | Advanced Control Circuit | Infused Alloy + Basic Control Circuit |
...
| | Speed Upgrade | Glass + Infused Alloy + Osmium Dust |
...
| | Energy Upgrade | Glass + Infused Alloy + Gold Dust |
...
| | Gas Upgrade | Glass + Infused Alloy + Iron Dust |
...
| | Muffling Upgrade | Glass + Infused Alloy + Steel Dust |
...
| | Filter Upgrade | Glass + Infused Alloy + Tin Dust |
...
| | Anchor Upgrade | Glass + Infused Alloy + Diamond Dust |
...
| | Farming Unit | HDPE Sheet + Iron Hoe + Module Base + Infused Alloy |
...
| | Elite Fluid Tank | Reinforced Alloy + Iron Ingot + Advanced Fluid Tank |
...
| | Elite Chemical Tank | Reinforced Alloy + Osmium Ingot + Advanced Chemical Tank |
...
| | Elite Control Circuit | Reinforced Alloy + Advanced Control Circuit |
...
Name | Ingredients | Crafting recipe |
— | — | — |
Teleportation Core | Lapis Lazuli +

Atomic Alloy + Diamond + Gold Ingot |
...
| | Gravitational Modulating Unit | Antimatter + Nether Star + Module Base + Atomic Alloy + Ultimate Induction Provide |
...
| | Ultimate Fluid Tank | Atomic Alloy + Iron Ingot + Elite Fluid Tank |
...
| | Ultimate Chemical Tank | Atomic Alloy + Osmium Ingot + Elite Chemical Tank |
...
| | Ultimate Control Circuit | Atomic Alloy + Elite Control Circuit |
