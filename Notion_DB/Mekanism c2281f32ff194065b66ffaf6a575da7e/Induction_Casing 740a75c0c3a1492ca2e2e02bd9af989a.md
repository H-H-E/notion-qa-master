...
Along with the Induction Port, **Induction Casing** makes up the multi-block that is the Induction Matrix, a energy storage structure that can hold a large amount of energy.
