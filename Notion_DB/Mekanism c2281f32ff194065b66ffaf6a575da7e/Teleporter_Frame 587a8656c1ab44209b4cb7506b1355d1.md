...
With the **Teleporter frame** together with the Teleporter you can create a Teleporter Portal. This portal can be walked directly into for instant teleportation. If you want true instant teleportation, place an Anchor Upgrade in the teleporter you would like to teleport to. If you only have two portals, you can connect the portals and build a portal system. Otherwise, it is recommended to have a single teleporter block on the ground.

## Construction

To set up a Teleporter Portal, set it up like a nether portal with the sides filled in, but with just enough room for a player to walk through (1x2).
