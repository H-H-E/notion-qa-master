...
| 20 RF/t |  |
|  |  |
| “A simple machine that serves as a Mekanism-based furnace that runs off of energy.” |  |

The energized smelter is your basic electric furnace that uses energy instead of fuel to smelt items.
...
Cobblestone + Glass + Steel Casing |
