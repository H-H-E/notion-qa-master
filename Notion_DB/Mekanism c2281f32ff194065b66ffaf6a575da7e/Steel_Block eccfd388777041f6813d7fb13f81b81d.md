...
Used as a storage and decoration block, along with other Aesthetic Blocks. It alone doesn’t have much use, other than being used as a display block unless needed.
...
| | Armored Jetpack | Jetpack + Diamond Dust + Bronze Ingot + Steel Block |
