...
**Enriched Redstone** is used in the Metallurgic Infuser.
...
Enriched redstone can be used in a Metallurgic Infuser with Osmium Ingot in order to create Basic Control Circuit, instead of using redstone dust. It is more efficient to use enriched redstone as it is worth 8 times more than normal redstone dust.
