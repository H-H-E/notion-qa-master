...
The **Hohlraum** is a critical tool for igniting the Fusion Reactor.
...
Coal or Charcoal or Block of Coal or Charcoal Block or Enriched Carbon |

|  | File:Grid Enriched Carbon.png |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
