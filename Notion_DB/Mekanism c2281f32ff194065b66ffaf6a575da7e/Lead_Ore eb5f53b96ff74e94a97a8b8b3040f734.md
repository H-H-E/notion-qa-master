...
**Lead Ore** is a somewhat rare metal that is excellent at resisting radioactive particles, spawning slightly less frequently than iron. It is one of the six ores added by Mekanism, like most of them, it can be either smelted into an Lead Ingot, or ground into two Lead Dust using an Enrichment Chamber.

## Smelting

## Enriching

**Script error: No such module “Enriching”.**
