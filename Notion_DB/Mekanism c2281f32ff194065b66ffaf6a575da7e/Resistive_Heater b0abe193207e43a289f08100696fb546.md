...
Tin Ingot + Steel Casing + Energy Tablet |
...
As shown below, the Resistive heater has a basic UI with a text input slot. In this test input, you can give the Resistive Heater a new consumption rate (in UNITS/t), which is measured in the currently selected unit. This can be changed by clicking the energy icon in the bottom-left corner.
