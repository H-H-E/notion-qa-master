...
The Farming unit is a Module that is applied to the Meka-Tool. It Gives the tool several agriculture-based functions, Up to 4 can be stacked on one tool.
...
Iron Hoe + Module Base + HDPE Sheet |
