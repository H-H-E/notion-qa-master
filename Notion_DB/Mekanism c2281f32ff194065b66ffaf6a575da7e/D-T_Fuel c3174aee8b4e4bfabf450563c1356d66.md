...
D-T Fuel is created by infusing Tritium and Deuterium in a Chemical Infuser.

It can be used as fuel in a Fusion Reactor which removes the set limit of 98mB/t injection rate and instead will use D-T fuel up as fast as possible to the max of 1000mB/t regardless of what has been set as the limit.
