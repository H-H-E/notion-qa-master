...
**Ore Shards** are used in Tier 3 ore processing: it is used in the quadrupling (4x) of ingot production.
...
**Getting the shards** A Chemical Injection Chamber or its Factory counterpart can be used to produce shards from ores.
