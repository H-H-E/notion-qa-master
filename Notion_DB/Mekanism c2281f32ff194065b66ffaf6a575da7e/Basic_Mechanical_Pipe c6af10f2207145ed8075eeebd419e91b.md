...
1. Push: Pushes held fluid into attached block
2. Pull: Pulls fluid from attached block
3. Normal: Default state
4. None: Disconnects the pipe from attached block.

These can be changed with the Configurator by Shift+Right clicking on the pipe connections.

## Contents

- 1 In-world upgrading
- 2 Rates
- 3 Crafting Recipes
