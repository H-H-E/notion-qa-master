...
The **Teleporter** is used with the Teleporter Frame to build a Teleporter Portal. For a detailed description of teleportation mechanics, see the Teleporter Portal page.
