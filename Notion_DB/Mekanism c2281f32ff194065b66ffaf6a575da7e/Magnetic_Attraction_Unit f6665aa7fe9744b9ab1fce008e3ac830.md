...
Magnetic Attraction Unit is a Module that is applied to the Mekasuit Boots. As the item Flavor text states “[The unit] Uses Powerful Magnets to draw distant items towards the player”, you can install up to 4 on one pair of boots.
...
Reinforced Alloy + Iron Bars + Module Base + Polonium Pellet |
