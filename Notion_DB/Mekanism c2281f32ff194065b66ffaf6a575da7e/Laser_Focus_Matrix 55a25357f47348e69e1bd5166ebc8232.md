...
The **Laser Focus Matrix** is a necessary block in creating the Fusion Reactor. You can ignite the reactor by aiming the output of a Laser Amplifier through these ports of the reactor and injecting sufficient energy (see the reactor Statistics Tab, but 1GJ will suffice).
