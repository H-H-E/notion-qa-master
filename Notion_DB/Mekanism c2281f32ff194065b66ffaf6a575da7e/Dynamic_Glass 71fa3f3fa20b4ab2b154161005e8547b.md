...
**NOTE**: Since Mekanism V9, this block no longer exists and is thus replaced by Structural Glass. You can use Structural Glass if you want to add glass onto any Mekanism multiblocks walls (not frames), with the exception of Fusion Reactors and Fission Reactors.
