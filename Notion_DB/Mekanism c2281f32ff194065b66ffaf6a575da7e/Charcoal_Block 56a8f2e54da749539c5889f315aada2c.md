...
Used as a storage and decoration block, along with other Aesthetic Blocks. However, unlike other metal blocks this can be used as a compact fuel source, just like a vanilla coal block.
