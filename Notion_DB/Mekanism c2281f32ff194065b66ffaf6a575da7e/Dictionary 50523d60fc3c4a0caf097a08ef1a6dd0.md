...
The **dictionary** allows you to check the ore dictionary and can be used in conjunction with the Digital Miner for a more precise mining experience. Additionally, it can be used with the Logistical Sorter to organize blocks and items, and it can be used with the Oredictionificator to unify ores from different mods.

## Use

Right click on any block with the dictionary in hand and it should tell you its dictionary key, if it has one.

Dictionary GUI You can also shift+right click to open a GUI. From here, you can place blocks or items from your inventory in the GUI’s slot and it will display all the available keys for it. For example, coal has both the **coal** and **itemCoal** keys associated with it.
...
— | — | — |
Oredictionificator | Steel Ingot +

Chest + Glass Pane + Dictionary + Basic Control Circuit |
