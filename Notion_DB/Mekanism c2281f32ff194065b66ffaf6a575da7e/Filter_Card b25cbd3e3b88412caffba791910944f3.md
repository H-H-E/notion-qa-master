...
**NOTE:** Since Mekanism V9, the Filter Card no longer exists, it is replaced by the Configuration Card. Filter Card is an item to save Digital Miner and Logistical Sorter filter settings.

## Usage

To copy the settings on the card, hold down the Shift key and right click on the set machine. To paste the setting onto the machine, hold the card and right click on the machine.
